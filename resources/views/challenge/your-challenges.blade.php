...
@section('content')
    ...
    <div class="container">
        @auth
            <div class="row">
                <div class="col-md text-center align-self-center index-col create-challenge">
                    <div class="new-challenge-blocks">
                        <h5>Create your own challenge</h5>
                        <a class="addIcon" href="{{ route('challenges.create') }}">
        ...
        @endauth
        <h1 class="most-popular-title">My Challenges</h1>
